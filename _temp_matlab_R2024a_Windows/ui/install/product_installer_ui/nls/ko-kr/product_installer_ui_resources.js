define({
    ...
    connectionErrorMsg: '응용 프로그램을 MathWorks에 연결할 수 없습니다.<br>이 문제를 해결하려면 <a href="https://www.mathworks.com/pi_dlerr_mpi " target="_blank">고객 지원팀</a>에 문의하십시오',
    ...
    missingJRETextRuntime: '이 응용 프로그램에는 Java Runtime이 필요합니다. <a href="https://www.mathworks.com/pi_mri_macajre_${0}_${1}" target="_blank">Java Runtime 설치</a>'
});
